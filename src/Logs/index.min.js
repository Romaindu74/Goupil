...
class Logs {
    ...
    /**
     * @param {{ formatfilename: string, prefixlog: string }} 
     */
    setup({ formatfilename, prefixlog }) {
        ...
        if ("string" == typeof formatfilename) {
            this.fn = formatfilename
        }

        if ("string" == typeof prefixlog) {
            this.pl = prefixlog
        }
    }
